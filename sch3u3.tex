...
\chemfig{\lewis{2:4:6:,C}-\lewis{0:2:6:,C}}
...
A total of 7+28+1 = 36 e$^{-}$.
\item Connect everything with single bonds \\
\chemfig{F-I(-[0]F)(-[2]F)(-[6]F)} \\
Each single bond is 2 electrons. So now we have 36 e$^{-}$ - 4$\times$2 e$^{-}$ = 36 e$^{-}$ - 8 e$^{-}$ = 28 e$^{-}$.
...
\chemfig{\lewis{2:4:6:,Cl}-B(-[6]\lewis{0:4:6:, Cl})-\lewis{0:2:6:,Cl}}
...
\begin{align*}
8 corners + 6 faces &= 8(\frac{1}{8}) + 6(\frac{1}{2})
&= 1 + 3
&= 4 particles
\end{align*}
...
\begin{align*}
8 corners + 1 centre &= 8(\frac{1}{8}) + 1(1)
&= 1 + 1
&= 2 particles
\end{align*}
\end{description}
...
\begin{align*}
12 edges + 1 centre &= 12(\frac{1}{4}) + 1(1)
&= 3 + 1
&= 4 Na^{-}
\end{align*}
...
Just look at the \href{http://abelmoodle.abel.yorku.ca/moodle/mod/resource/view.php?id=78307}{slides}.
\end{document}
